...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_ostos_onnistuu_kun_kortilla_kaksi_ja_puoli_euroa(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_maukkaan_lounaan_ostos_onnistuu_kun_kortilla_nelja_euroa(self):
